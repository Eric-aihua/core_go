...
/*
使用协成批量ping dbl_sample文件中定义的域名，并打印出域名和IP的映射关系，IP未知的情况下将输出unknown
*/
func main() {
	var count int
	var timeout int64
...
func ping(h *string, c chan string, args map[string]interface{}) {
	//	fmt.Println(*h)
	var count int
	var size int
	var timeout int64
